      ...
      <div className="flex flex-col gap-2">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-2">
          <div className="bg-white shadow-2xl p-2 flex flex-col gap-2">
            ...
            <h4>Anmeldung</h4>
            <p>
              Die Plätze sind begrenzt, daher empfehlen wir euch, euch rechtzeitig anzumelden. Schickt uns einfach eine
              E-Mail an <Link href="mailto:kerstin.fischer@svwalddorf.de">kerstin.fischer@svwalddorf.de</Link> mit dem
              Betreff <i>Hobbyhorsing-Kurs</i> und euren Kontaktdaten. Wir setzen uns dann umgehend mit euch in
              Verbindung.
            </p>
            <p>
          ...
          <div className="bg-white shadow-2xl p-2 flex flex-col gap-2">
            ...
            <p>
              <ul>
                <li>Beginn: 22.09.2023</li>
                <li>Kursdauer: 15 Termine</li>
                <li>Immer freitags, 16:30 – 18:15 Uhr</li>
                <li>Kinder im Alter von 9 bis 15 Jahre</li>
                <li>Kursgebühr: 20,-€ für Vereinsmitglieder</li>
